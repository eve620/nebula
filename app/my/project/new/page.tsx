...
import { Label } from "@/components/ui/label"
import Image from 'next/image'
import { Eye, Trash2, CalendarIcon, Plus, X } from 'lucide-react'
import { Modal } from "@/components/modal/modal"
import showMessage from "@/components/message"
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover"
import { cn } from "@/lib/utils"
                    ...
                    <div className="gap-6">
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <Input id="responsibility" name="responsibility" value={job} onChange={(e) => setJob(e.target.value)} required />
                            </div>
                        </div>
                        <div className="space-y-4">
                            <div>
                            ...
                            <div>
                                ...
                                <Textarea id="description" name="description" value={describe} onChange={(e) => setDescribe(e.target.value)} required />
                            </div>
                            <div>
                                <Label htmlFor="highlights">亮点</Label>
                                <Textarea id="highlights" name="highlights" value={highlight} onChange={(e) => setHighlight(e.target.value)} required />
                            </div>
                        </div>
                    </div>
                    <div>
