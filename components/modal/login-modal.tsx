...
export function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      if (isRegistering) {
        ...
        // 这里应该有注册逻辑
        console.log('Registration attempted with:', username, password, nickname)
      } else {
  ...
  return (
      <Modal isOpen={isOpen} onClose={onClose} title={isRegistering ? "注册" : "登录"} description="输入您的账号信息以访问绝区零的世界。">
